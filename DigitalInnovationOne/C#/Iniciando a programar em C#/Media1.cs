...
ponto decimal e com um espaço em branco antes e depois da igualdade. Utilize variáveis 
de dupla precisão (double) e como todos os problemas, não esqueça de imprimir o fim 
...
class Media1 {
    ...
    static void Main(string[] args) { 
            ...
            Console.WriteLine("MEDIA = {0}", average.ToString("0.00000"));
