...
// pimentões na sacola.  Você receberá 2 inteiros que devem ser lidos e armazenados
// nas variáveis A (pimentões amarelos) e B (pimentões vermelhos). Faça a soma de A e B atribuindo o
// seu resultado na variável X (total de pimentões). Apresente X como descrito na mensagem de exemplo abaixo.
...
// e pelo final de linha. Assegure que exista um espaço antes e depois do sinal de igualdade.
//
//|---------------------------------------------------------------|
