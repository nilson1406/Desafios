...
// Weblogger Brasil permite aos autores fazer o mesmo com pares do caractere asterisco, '*'. Quando
// um autor escreve o texto
//
...
// string texto, com zero ou mais usos dos atalhos itálico e negrito. Cada texto tem de 1 a 50 caracteres,
// inclusive. Os únicos caracteres permitidos no texto são os caracteres alfabéticos
// (de 'a' a 'z' e de 'A' a 'Z'), o sublinhado ('_'), o asterisco ('*'), o caractere de espaço e os
// símbolos de pontuação ',', ';', '.', '!', '?', '-', '(' e ')'. O caractere sublinhado '_' ocorre no
// texto um número par de vezes. O asterisco '*' também aparece um número par de vezes no texto. Nenhuma
// substring do texto entre um par de sublinhados ou entre um par de asteriscos pode conter outros
...
// como demonstrado nos exemplos abaixo. Para tornar itálico um pedaço de texto no HTML, você deve iniciar
// este pedaço com a tag <i> e terminá-lo com a tag </i>. Para texto em negrito, inicie com <b> e termine
// com </b>.
//
//|-------------------------------------------------------------------------------------------|
...
public class AtalhosParaWebloggerBrasil {
